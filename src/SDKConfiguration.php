...
use Midday\Midday\Utils\Retry\RetryConfig;
...
class SDKConfiguration
{
    ...
    public string $genVersion = '2.677.3';

    public string $userAgent = 'speakeasy-sdk/php 0.0.2 2.677.3 0.0.1 midday/midday-php';
    ...
    public function getServerUrl(): string
    {
        ...
        if (isset(Midday::SERVERS[$this->serverIndex])) {
            return Midday::SERVERS[$this->serverIndex];
        } else {
    ...
    public function getServerDetails(): Utils\ServerDetails
    {
        ...
        return new Utils\ServerDetails(Midday::SERVERS[$this->serverIndex], []);
