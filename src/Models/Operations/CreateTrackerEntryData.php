...
class CreateTrackerEntryData
{
     ...
     *
     * @var CreateTrackerEntryUser $user
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('user')]
    #[\Speakeasy\Serializer\Annotation\Type('\Midday\Midday\Models\Operations\CreateTrackerEntryUser')]
    public CreateTrackerEntryUser $user;

    /**
     * Project information associated with this tracker entry
     *
     * @var CreateTrackerEntryProject $project
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('project')]
    #[\Speakeasy\Serializer\Annotation\Type('\Midday\Midday\Models\Operations\CreateTrackerEntryProject')]
    public CreateTrackerEntryProject $project;
     ...
     * @param  bool  $billed
     * @param  string  $date
     * @param  CreateTrackerEntryUser  $user
     * @param  CreateTrackerEntryProject  $project
     * @param  ?string  $description
     * @param  ?float  $rate
     * @param  ?string  $currency
     * @phpstan-pure
     */
    public function __construct(string $id, string $createdAt, float $duration, string $start, string $stop, string $teamId, bool $billed, string $date, CreateTrackerEntryUser $user, CreateTrackerEntryProject $project, ?string $description = null, ?float $rate = null, ?string $currency = null)
    {
        $this->id = $id;
