...
class StartTimerProject
{
     ...
     *
     * @var ?StartTimerCustomer $customer
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('customer')]
    #[\Speakeasy\Serializer\Annotation\Type('\Midday\Midday\Models\Operations\StartTimerCustomer|null')]
    public ?StartTimerCustomer $customer;
     ...
     * @param  ?StartTimerCustomer  $customer
     * @phpstan-pure
     */
    public function __construct(string $id, string $createdAt, string $status, string $name, ?float $rate = null, ?string $currency = null, ?string $description = null, ?bool $billable = null, ?float $estimate = null, ?StartTimerCustomer $customer = null)
    {
        $this->id = $id;
