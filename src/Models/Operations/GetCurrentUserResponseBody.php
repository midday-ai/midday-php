...
class GetCurrentUserResponseBody
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $fullName, string $email, ?string $avatarUrl = null, ?string $locale = null, ?bool $weekStartsOnMonday = null, ?string $timezone = null, ?bool $timezoneAutoSync = null, ?float $timeFormat = null, ?GetCurrentUserDateFormat $dateFormat = null, ?GetCurrentUserTeam $team = null)
    {
        $this->id = $id;
