...
class StartTimerData
{
     ...
     *
     * @var StartTimerUser $user
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('user')]
    #[\Speakeasy\Serializer\Annotation\Type('\Midday\Midday\Models\Operations\StartTimerUser')]
    public StartTimerUser $user;

    /**
     * Project information associated with this tracker entry
     *
     * @var StartTimerProject $project
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('project')]
    #[\Speakeasy\Serializer\Annotation\Type('\Midday\Midday\Models\Operations\StartTimerProject')]
    public StartTimerProject $project;
     ...
     * @param  bool  $billed
     * @param  string  $date
     * @param  StartTimerUser  $user
     * @param  StartTimerProject  $project
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $createdAt, string $start, string $stop, string $teamId, bool $billed, string $date, StartTimerUser $user, StartTimerProject $project, ?float $duration = null, ?string $description = null, ?float $rate = null, ?string $currency = null)
    {
        $this->id = $id;
