...
class RequestBody
{
     ...
     *
     * @var ?array<CreateTransactionsAttachment> $attachments
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('attachments')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Midday\Midday\Models\Operations\CreateTransactionsAttachment>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  ?string  $note
     * @param  ?bool  $internal
     * @param  ?array<CreateTransactionsAttachment>  $attachments
     * @phpstan-pure
     */
