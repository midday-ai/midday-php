...
class StopTimerData
{
     ...
     *
     * @var StopTimerUser $user
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('user')]
    #[\Speakeasy\Serializer\Annotation\Type('\Midday\Midday\Models\Operations\StopTimerUser')]
    public StopTimerUser $user;

    /**
     * Project information associated with this tracker entry
     *
     * @var StopTimerProject $project
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('project')]
    #[\Speakeasy\Serializer\Annotation\Type('\Midday\Midday\Models\Operations\StopTimerProject')]
    public StopTimerProject $project;
     ...
     * @param  bool  $billed
     * @param  string  $date
     * @param  StopTimerUser  $user
     * @param  StopTimerProject  $project
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $createdAt, string $start, string $stop, string $teamId, bool $billed, string $date, StopTimerUser $user, StopTimerProject $project, ?float $duration = null, ?string $description = null, ?float $rate = null, ?string $currency = null)
    {
        $this->id = $id;
