...
class UpdateInboxItemResponseBody
{
    /**
     * Inbox item ID (UUID)
     *
     ...
     *
     * @var ?UpdateInboxItemTransaction $transaction
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('transaction')]
    #[\Speakeasy\Serializer\Annotation\Type('\Midday\Midday\Models\Operations\UpdateInboxItemTransaction|null')]
    public ?UpdateInboxItemTransaction $transaction;
     ...
     * @param  ?UpdateInboxItemTransaction  $transaction
     * @phpstan-pure
     */
    public function __construct(string $id, string $fileName, array $filePath, string $displayName, string $status, string $createdAt, ?float $amount = null, ?string $currency = null, ?string $contentType = null, ?string $date = null, ?string $website = null, ?string $description = null, ?UpdateInboxItemTransaction $transaction = null)
    {
        $this->id = $id;
