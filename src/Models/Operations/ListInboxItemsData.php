...
class ListInboxItemsData
{
     ...
     *
     * @var ?ListInboxItemsTransaction $transaction
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('transaction')]
    #[\Speakeasy\Serializer\Annotation\Type('\Midday\Midday\Models\Operations\ListInboxItemsTransaction|null')]
    public ?ListInboxItemsTransaction $transaction;
     ...
     * @param  ?ListInboxItemsTransaction  $transaction
     * @phpstan-pure
     */
    public function __construct(string $id, string $fileName, array $filePath, string $displayName, string $status, string $createdAt, ?float $amount = null, ?string $currency = null, ?string $contentType = null, ?string $date = null, ?string $website = null, ?string $description = null, ?ListInboxItemsTransaction $transaction = null)
    {
        $this->id = $id;
