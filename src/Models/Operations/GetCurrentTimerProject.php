...
class GetCurrentTimerProject
{
     ...
     *
     * @var ?GetCurrentTimerCustomer $customer
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('customer')]
    #[\Speakeasy\Serializer\Annotation\Type('\Midday\Midday\Models\Operations\GetCurrentTimerCustomer|null')]
    public ?GetCurrentTimerCustomer $customer;
     ...
     * @param  ?GetCurrentTimerCustomer  $customer
     * @phpstan-pure
     */
    public function __construct(string $id, string $createdAt, string $status, string $name, ?float $rate = null, ?string $currency = null, ?string $description = null, ?bool $billable = null, ?float $estimate = null, ?GetCurrentTimerCustomer $customer = null)
    {
        $this->id = $id;
