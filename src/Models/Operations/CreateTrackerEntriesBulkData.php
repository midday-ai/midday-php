...
class CreateTrackerEntriesBulkData
{
    /**
     ...
     *
     * @var CreateTrackerEntriesBulkUser $user
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('user')]
    #[\Speakeasy\Serializer\Annotation\Type('\Midday\Midday\Models\Operations\CreateTrackerEntriesBulkUser')]
    public CreateTrackerEntriesBulkUser $user;

    /**
     * Project information associated with this tracker entry
     *
     * @var CreateTrackerEntriesBulkProject $project
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('project')]
    #[\Speakeasy\Serializer\Annotation\Type('\Midday\Midday\Models\Operations\CreateTrackerEntriesBulkProject')]
    public CreateTrackerEntriesBulkProject $project;
     ...
     * @param  bool  $billed
     * @param  string  $date
     * @param  CreateTrackerEntriesBulkUser  $user
     * @param  CreateTrackerEntriesBulkProject  $project
     * @param  ?string  $description
     * @param  ?float  $rate
     * @param  ?string  $currency
     * @phpstan-pure
     */
    public function __construct(string $id, string $createdAt, float $duration, string $start, string $stop, string $teamId, bool $billed, string $date, CreateTrackerEntriesBulkUser $user, CreateTrackerEntriesBulkProject $project, ?string $description = null, ?float $rate = null, ?string $currency = null)
    {
        $this->id = $id;
